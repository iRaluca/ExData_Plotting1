...
plot3 <- function(){
        ...
        #plot required data
        with(powerconsumption, plot(Date, Sub_metering_1, type="n", ylab = "Energy sub metering", xlab = "")) 
        with(powerconsumption, lines(Date, Sub_metering_1, type = "l"))
        with(powerconsumption, lines(Date, Sub_metering_2, type = "l", col = "red"))
        with(powerconsumption, lines(Date, Sub_metering_3, type = "l", col = "blue"))
